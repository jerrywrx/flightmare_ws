...
echo_and_run cd "/home/jerrywang/flightmare_ws/src/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/home/jerrywang/flightmare_ws/src/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/jerrywang/flightmare_ws/build/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
